...
<body>
  ...
  <!-- <div class="aside">
    ...
    <ul class="nav">
      ...
      <li>
        <a href="posts.php" class="collapsed" data-toggle="collapse">
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="posts.php" class="collapse">
      ...
      <li>
        <a href="settings.php" class="collapsed" data-toggle="collapse">
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="settings.php" class="collapse">
